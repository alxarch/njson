...
var (
	...
	prefix   = flag.String("prefix", "mask", "Var name prefix")
)
...
var tpl = template.Must(template.New("masks").Parse(`// Code generated by genmask; DO NOT EDIT.
package {{.PkgName}}

const (
{{- range $name, $mask := .Masks }}
	{{$name}} = {{ printf "%q" $mask }}
{{- end }}
)
`))
